...
//Szukites szerzo szerint
  ...
  szerzoC.addEventListener('click', (e) => {
    const szukitettDatas = ujEletDatas.filter( data => {
      return data.kiirni.includes('UE04085') + data.kiirni.includes('UE05050')
      + data.kiirni.includes('UE02008') + data.kiirni.includes('UE04441')
      + data.kiirni.includes('UE04673') + data.kiirni.includes('UE02665')
      + data.kiirni.includes('UE01696') + data.kiirni.includes('UE05589')
      + data.kiirni.includes('UE05590') + data.kiirni.includes('UE02890')
      + data.kiirni.includes('UE00177') + data.kiirni.includes('UE04056')
      + data.kiirni.includes('UE05109') + data.kiirni.includes('UE08179')
      + data.kiirni.includes('UE05870') + data.kiirni.includes('UE05657')
      + data.kiirni.includes('UE00266') + data.kiirni.includes('UE01536')
      + data.kiirni.includes('UE02478') + data.kiirni.includes('UE06866')
      + data.kiirni.includes('UE00034') + data.kiirni.includes('UE07717')
      + data.kiirni.includes('UE07752') + data.kiirni.includes('UE07783')
      + data.kiirni.includes('UE07821') + data.kiirni.includes('UE07856')
      + data.kiirni.includes('UE07886') + data.kiirni.includes('UE07926')
      + data.kiirni.includes('UE07959') + data.kiirni.includes('UE07994')
      + data.kiirni.includes('UE08029') + data.kiirni.includes('UE08057')
      + data.kiirni.includes('UE03498') + data.kiirni.includes('UE04566')
      + data.kiirni.includes('UE05785') + data.kiirni.includes('UE05966')
      + data.kiirni.includes('UE06608') + data.kiirni.includes('UE06742')
      + data.kiirni.includes('UE07424') + data.kiirni.includes('UE06018')
      + data.kiirni.includes('UE08066') + data.kiirni.includes('UE07721')
      + data.kiirni.includes('UE08391') + data.kiirni.includes('UE04890')
      + data.kiirni.includes('UE00367') + data.kiirni.includes('UE06055')
      + data.kiirni.includes('UE00659') + data.kiirni.includes('UE03654')
      + data.kiirni.includes('UE00146') + data.kiirni.includes('UE03068')
      + data.kiirni.includes('UE05010') + data.kiirni.includes('UE07488')
      + data.kiirni.includes('UE07489') + data.kiirni.includes('UE08188')
      + data.kiirni.includes('UE08189') + data.kiirni.includes('UE08190')
      + data.kiirni.includes('UE08215') + data.kiirni.includes('UE04670')
      + data.kiirni.includes('UE02998') + data.kiirni.includes('UE05086')
      + data.kiirni.includes('UE03370') + data.kiirni.includes('UE03776')
      + data.kiirni.includes('UE04086') + data.kiirni.includes('UE07848')
      + data.kiirni.includes('UE01938') + data.kiirni.includes('UE05894')
      + data.kiirni.includes('UE01644') + data.kiirni.includes('UE05546')
      + data.kiirni.includes('UE05547') + data.kiirni.includes('UE06166')
      + data.kiirni.includes('UE07070') + data.kiirni.includes('UE07816')
      + data.kiirni.includes('UE03764') + data.kiirni.includes('UE04370')
      + data.kiirni.includes('UE04406') + data.kiirni.includes('UE00483')
      + data.kiirni.includes('UE00567') + data.kiirni.includes('UE00590')
      + data.kiirni.includes('UE01940') + data.kiirni.includes('UE03245')
      + data.kiirni.includes('UE07322') + data.kiirni.includes('UE07702')
      + data.kiirni.includes('UE07805') + data.kiirni.includes('UE08044')
      + data.kiirni.includes('UE05977') + data.kiirni.includes('UE01733')
      + data.kiirni.includes('UE01848') + data.kiirni.includes('UE04957')
      + data.kiirni.includes('UE04323') + data.kiirni.includes('UE05005')
      + data.kiirni.includes('UE02982') + data.kiirni.includes('UE03163')
      + data.kiirni.includes('UE03194') + data.kiirni.includes('UE05006')
      + data.kiirni.includes('UE06538') + data.kiirni.includes('UE07060')
      + data.kiirni.includes('UE08169') + data.kiirni.includes('UE00579')
      + data.kiirni.includes('UE00580') + data.kiirni.includes('UE08267')
      + data.kiirni.includes('UE01898') + data.kiirni.includes('UE01925')
      + data.kiirni.includes('UE02134') + data.kiirni.includes('UE02252')
      + data.kiirni.includes('UE02409') + data.kiirni.includes('UE02584')
      + data.kiirni.includes('UE02634') + data.kiirni.includes('UE03000')
      + data.kiirni.includes('UE03015') + data.kiirni.includes('UE03043')
      + data.kiirni.includes('UE03597') + data.kiirni.includes('UE03681')
      + data.kiirni.includes('UE03712') + data.kiirni.includes('UE03842')
      + data.kiirni.includes('UE04124') + data.kiirni.includes('UE05226')
      + data.kiirni.includes('UE05296') + data.kiirni.includes('UE05784')
      + data.kiirni.includes('UE05988') + data.kiirni.includes('UE06014')
      + data.kiirni.includes('UE06258') + data.kiirni.includes('UE08389')
      + data.kiirni.includes('UE07781') + data.kiirni.includes('UE00226')
      + data.kiirni.includes('UE05864') + data.kiirni.includes('UE03856')
      + data.kiirni.includes('UE06713') + data.kiirni.includes('UE00411')
      + data.kiirni.includes('UE05199') + data.kiirni.includes('UE04584')
      + data.kiirni.includes('UE04671') + data.kiirni.includes('UE04823')
      + data.kiirni.includes('UE04939') + data.kiirni.includes('UE02421')
      + data.kiirni.includes('UE02675') + data.kiirni.includes('UE02793')
      + data.kiirni.includes('UE03062') + data.kiirni.includes('UE03228')
      + data.kiirni.includes('UE03229') + data.kiirni.includes('UE03491')
      + data.kiirni.includes('UE03573') + data.kiirni.includes('UE04572')
      + data.kiirni.includes('UE04608') + data.kiirni.includes('UE04955')
      + data.kiirni.includes('UE05252') + data.kiirni.includes('UE06947')
      + data.kiirni.includes('UE07367') + data.kiirni.includes('UE05031')
      + data.kiirni.includes('UE05956') + data.kiirni.includes('UE00544')
      + data.kiirni.includes('UE04228') + data.kiirni.includes('UE08249')
      + data.kiirni.includes('UE08253') + data.kiirni.includes('UE02325')
      + data.kiirni.includes('UE01996') + data.kiirni.includes('UE02758')
    });
    displayDatas(szukitettDatas);
  });
